...
class PrecomputadosSetor extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $core.int get totalEsportivas => $_getIZ(1);
  @$pb.TagNumber(4)
  set totalEsportivas($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(4)
  $core.bool hasTotalEsportivas() => $_has(1);
  @$pb.TagNumber(4)
  void clearTotalEsportivas() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.int get totalMoveis => $_getIZ(2);
  @$pb.TagNumber(5)
  set totalMoveis($core.int value) => $_setSignedInt32(2, value);
  @$pb.TagNumber(5)
  $core.bool hasTotalMoveis() => $_has(2);
  @$pb.TagNumber(5)
  void clearTotalMoveis() => $_clearField(5);

  @$pb.TagNumber(6)
  $core.int get totalBoulders => $_getIZ(3);
  @$pb.TagNumber(6)
  set totalBoulders($core.int value) => $_setSignedInt32(3, value);
  @$pb.TagNumber(6)
  $core.bool hasTotalBoulders() => $_has(3);
  @$pb.TagNumber(6)
  void clearTotalBoulders() => $_clearField(6);

  @$pb.TagNumber(7)
  $core.int get totalMultiplasEnfiadas => $_getIZ(4);
  @$pb.TagNumber(7)
  set totalMultiplasEnfiadas($core.int value) => $_setSignedInt32(4, value);
  @$pb.TagNumber(7)
  $core.bool hasTotalMultiplasEnfiadas() => $_has(4);
  @$pb.TagNumber(7)
  void clearTotalMultiplasEnfiadas() => $_clearField(7);

  @$pb.TagNumber(8)
  $core.int get totalHighlines => $_getIZ(5);
  @$pb.TagNumber(8)
  set totalHighlines($core.int value) => $_setSignedInt32(5, value);
  @$pb.TagNumber(8)
  $core.bool hasTotalHighlines() => $_has(5);
  @$pb.TagNumber(8)
...
class Grupo extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(9)
  PrecomputadosGrupo get precomputados => $_getN(6);
  @$pb.TagNumber(9)
  set precomputados(PrecomputadosGrupo value) => $_setField(9, value);
  @$pb.TagNumber(9)
  $core.bool hasPrecomputados() => $_has(6);
  @$pb.TagNumber(9)
  void clearPrecomputados() => $_clearField(9);
  @$pb.TagNumber(9)
  PrecomputadosGrupo ensurePrecomputados() => $_ensure(6);
}
...
class Setor extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(15)
  PrecomputadosSetor get precomputados => $_getN(10);
  @$pb.TagNumber(15)
  set precomputados(PrecomputadosSetor value) => $_setField(15, value);
  @$pb.TagNumber(15)
  $core.bool hasPrecomputados() => $_has(10);
  @$pb.TagNumber(15)
  void clearPrecomputados() => $_clearField(15);
  @$pb.TagNumber(15)
  PrecomputadosSetor ensurePrecomputados() => $_ensure(10);
}
...
class CroquiExt {
  ...
  static final booleanoTextoNao = $pb.Extension<$core.String>(
      ...
      50011,
      $pb.PbFieldType.OS);
  static final nomeArquivoImagem = $pb.Extension<$core.String>(
      _omitMessageNames ? '' : 'google.protobuf.FieldOptions',
